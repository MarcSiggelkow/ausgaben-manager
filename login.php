...
<body>
  <div class="login-form">
    <form action="" method="POST" autocomplete="off">
      <h2 class="text-center">Der nice Budget Manager</h2>
      ...
      <div class="clearfix">
        <label class="float-left form-check-label"><input type="checkbox"> Anmeldung merken</label>
        
      </div>
    </form>
    <p class="text-center">Noch kein Account?<a href="register.php" class="text-danger"> Registrieren</a></p>
  </div>
</body>
